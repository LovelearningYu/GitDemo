...
<el-col :span="24">
  ...
  <div id="text1lay" class="fontlay smaltitle"><span style="cursor:pointer">用户注册</span></div>
...
<h2>注册系统账号</h2>
<el-form-item prop="name"><el-input type="text" placeholder="用户名" v-model="ruleForm.name"></el-input></el-form-item>
...
<el-form-item prop="dpt"><el-input type="text" placeholder="所在部门" v-model.number="ruleForm.dpt"></el-input></el-form-item>
...
<el-form-item prop="scrip"><el-input
  type="textarea"
  :autosize="{ minRows: 2, maxRows: 4}"
  placeholder="请输入用户特征"
  v-model="ruleForm.scrip"
  style="width:300px;">
</el-input></el-form-item>

<el-form-item prop="checkbox">
   <el-checkbox v-model="ruleForm.checkbox"><span style="color:#999999">我已阅读并同意</span><span style="color:#B2976A">本系统用户服务条款</span><span style="color:#999999">和</span><span style="color:#B2976A">隐私政策</span></el-checkbox>
</el-form-item>
 <el-form-item> <el-button @click="submitForm('ruleForm')">立即注册</el-button></el-form-item>
